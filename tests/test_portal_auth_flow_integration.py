...
async def test_portal_teacher_and_admin_sequences_for_role_specific_endpoints(
    ...
    teacher = await login_smoke_portal_session(api_client, role="teacher")
    admin = await login_smoke_portal_session(api_client, role="admin")
